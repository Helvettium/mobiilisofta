...
class RoutesResultsCardAdapter (private val inputData: Array<String>):
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.cardView.findViewById<TextView>(R.id.routeDepartsTextView).text = inputData[position]
    }
